...
<body>
    <div class="d-flex">
        ...
        <div class="container flex-grow-1">
            ...
            <h1 class="text-center" style="padding-top:10px; padding-bottom:10px; font-weight:bold; margin-top:40px;">Car Section</h1>
            <div class="pic_group">
                <div class="pic_option">
                    <div><img src="photos/car logos_images/acura.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox1" name="checkbox1"class ="checkbox-group">
                    <label for="checkbox1" value="">Acura</label>
                </div>

                <div class="pic_option">
                    <div><img src="photos/car logos_images/audi.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox2" name="checkbox2"class ="checkbox-group">
                    <label for="checkbox2" value="">Audi</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/bmw.png" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox3" name="checkbox3"class ="checkbox-group">
                    <label for="checkbox3" value="">BMW</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/bugatti.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox4" name="checkbox4"class ="checkbox-group">
                    <label for="checkbox4" value="">Bugatti</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/cadillac.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox5" name="checkbox5"class ="checkbox-group">
                    <label for="checkbox5" value="">Cadillac</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/dacia.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox6" name="checkbox6"class ="checkbox-group">
                    <label for="checkbox6">Dacia</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/ferrari.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox7" name="checkbox7"class ="checkbox-group">
                    <label for="checkbox7">Ferrari</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/holden.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox8" name="checkbox8"class ="checkbox-group">
                    <label for="checkbox8">Holden</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/infiniti.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox9" name="checkbox9"class ="checkbox-group">
                    <label for="checkbox9">infiniti</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/jaguar.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox10" name="checkbox10"class ="checkbox-group">
                    <label for="checkbox10">Jaguar</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/kia.png" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox11" name="checkbox11"class ="checkbox-group">
                    <label for="checkbox11">Kia</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/koenigsegg.png" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox12" name="checkbox12"class ="checkbox-group">
                    <label for="checkbox12">Koenignesgg</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/porsche.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox13" name="checkbox13" class ="checkbox-group">
                    <label for="checkbox13">porsche</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/rollsroyce.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox14" name="checkbox14"class ="checkbox-group">
                    <label for="checkbox14">Rollsroyce</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/lamborghini.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox15" name="checkbox15"class ="checkbox-group">
                    <label for="checkbox15">Lamborghini</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/maserati.png" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox16" name="checkbox16"class ="checkbox-group">
                    <label for="checkbox16">Maserati</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/mclaren.png" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox17" name="checkbox17"class ="checkbox-group">
                    <label for="checkbox17">Mclaren</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/seat.png" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox18" name="checkbox18"class ="checkbox-group">
                    <label for="checkbox18">Seat</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/volkswagen.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox19" name="checkbox19"class ="checkbox-group">
                    <label for="checkbox19">Volkswagen</label>
                </div>
                <div class="pic_option">
                    <div><img src="photos/car logos_images/astonmartin.jpg" alt="Cinque Terre"></div>
                    <input type="checkbox" id="checkbox20" name="checkbox20"class ="checkbox-group">
                    <label for="checkbox20">Astonmartin</label>
                </div>
