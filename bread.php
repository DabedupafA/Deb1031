        ...
        <div class="dropdown">
            ...
            <div class="pic_group" style="padding-bottom:10px;">
                <div class="choice-container"style="padding-bottom:20px; margin-top: 50px;">
                     ...
                     <div><img src="photos/bread_images/bagel.jpg" alt="Bagel"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color"onclick="updateInputBoxes('Bagel', 'Bagel', '55.00');toggleSelection(this, 'Bagel', '55.00'); ">Bagel - <strong>P50</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/baguette.jpg" alt="Baguette"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color"onclick="updateInputBoxes('Baguette', 'Baguette', '55.00');toggleSelection(this, 'Bagel', '55.00'); ">Baguette - <strong>P55</strong></a>
                    </div>  
                    <div class="pic_option">
                    <div><img src="photos/bread_images/brioches.jpg" alt="Brioches"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Brioches', 'Brioches', '55.00');toggleSelection(this, 'Bagel', '55.00'); ">Brioches - <strong>P55</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/challah.jpg" alt="Challah"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Challah', 'Challah', '66.00');toggleSelection(this, 'Bagel', '55.00'); ">Challah - <strong>P66</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/chapati.jpg" alt="Chapati"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Chapati', 'Chapati', '75.00');toggleSelection(this, 'Bagel', '55.00'); ">Chapati - <strong>P75</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/ciabatta.jpg" alt="Ciabatta"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Ciabatta', 'Ciabatta', '45.00');toggleSelection(this, 'Bagel', '55.00'); ">Ciabatta - <strong>P45</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/muffin.jpg" alt="English Muffin"></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('English Muffin', 'English Muffin', '70.00');toggleSelection(this, 'Bagel', '55.00'); ">Eng Muffin - <strong>P70</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/matzo.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Matzo', 'Matzo', '55.00');toggleSelection(this, 'Bagel', '55.00'); ">Matzo - <strong>P55</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/multigrain.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes(' MultiGrain', ' MultiGrain', '60.00');toggleSelection(this, 'Bagel', '55.00'); ">MultiGrain - <strong>P60</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/naan-bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Naan Bread ', 'Naan Bread ', '50.00');toggleSelection(this, 'Bagel', '55.00'); ">Naan Bread  - <strong>P50</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/pita-bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Pita Bread', 'Pita Bread', '70.00');toggleSelection(this, 'Bagel', '55.00'); ">Pita Bread - <strong>P70</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/rye-bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Rye Bread', 'Rye Bread', '55.00');toggleSelection(this, 'Bagel', '55.00'); ">Rye Bread - <strong>P55</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/soda-bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Soda Bread ', 'Soda Bread ', '45.00');toggleSelection(this, 'Bagel', '55.00'); ">Soda Bread  - <strong>P45</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/sour bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes(' Sour Bread', ' Sour Bread', '55.00');toggleSelection(this, 'Bagel', '55.00'); "> Sour Bread - <strong>P55</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/crispbread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Swedish Bread', 'Swedish Bread', '40.00');toggleSelection(this, 'Bagel', '55.00'); ">Swed Bread - <strong>P40</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/tortilla.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Tortilla', 'Tortilla', '100.00');toggleSelection(this, 'Bagel', '55.00'); ">Tortilla - <strong>P100</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/white-bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('White Bread', 'White Bread', '30.00');toggleSelection(this, 'Bagel', '55.00'); ">White Bread - <strong>P30</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/wholemeal-bread.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Whole Bread', 'Whole Bread', '80.00');toggleSelection(this, 'Bagel', '55.00'); ">Whole Bread - <strong>P80</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/focaccia.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Focaccia', 'Focaccia', '100.00');toggleSelection(this, 'Bagel', '55.00'); ">Focaccia - <strong>P100</strong></a>
                    </div>
                    <div class="pic_option">
                    <div><img src="photos/bread_images/gluten.jpg" alt=""></div>
                    <a href="javascript:void(0);" class="text-choice custom-font-color" onclick="updateInputBoxes('Gluten Bread', 'Gluten Bread', '70.00');toggleSelection(this, 'Bagel', '55.00'); ">Gluten Bread- <strong>P70</strong></a>
                    </div>
                </div>
            </div> 
