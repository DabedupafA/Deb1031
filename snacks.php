...
<body>
    <div class="d-flex">
        ...
        <div class="container flex-grow-1">
            ...
            <h1 class="text-center" style="padding-top:10px; padding-bottom:10px; font-weight:bold; margin-top:40px;">SNACK SECTION</h1>
            <div class="pic_group">
                ...
                <div class="pic_option">
                    <div><img src="photos/snacks_images/Crispy-Lumpia.jpg" alt="Cinque Terre"></div>
